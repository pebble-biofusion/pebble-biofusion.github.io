...
### 📊 Presentations
- [Main Tutorial Presentation](presentations/260725_spudecell_tutorials.pptx) - Comprehensive tutorial on SpudCell modeling
- [Methodology Overview](presentations/methodology-slides.pptx) - Detailed methodology and theoretical background

### 💻 Code & Analysis
- [Main Analysis Notebook](notebooks/spudcell_whole_cell_cycle_ODE.ipynb) - Interactive Jupyter notebook with ODE analysis
- [Simulation Scripts](notebooks/spudcell_simulation_results.csv) - Simulation results and outputs
- [Trajectory Data](notebooks/spudcell_ODE_trajectories.csv) - Cell cycle trajectory data

### 📈 Data & Outputs
- [ODE Generation Endpoints](manuscripts/spudcell_ODE_generation_endpoints.csv) - Key endpoints from ODE generation
- [Simulation Results](notebooks/spudcell_simulation_results.csv) - Complete simulation dataset
...
3. Start Jupyter: `jupyter notebook notebooks/spudcell_whole_cell_cycle_ODE.ipynb`
